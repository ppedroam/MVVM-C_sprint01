//
//  CompleteCreateAccountController.swift
//  mvvmcDevSprint
//
//  Created by Pedro Menezes on 25/09/22.
//

import Foundation
import UIKit

class CompleteCreateAccountViewController: UIViewController {
...
// MARK: - Actions
    ...
    @IBAction func showConfirmPassword(_ sender: Any) {
        if(showConfirmPassword == true) {
            ...
            showConfirmPasswordButton.setImage(UIImage.init(systemName: "eye.slash"), for: .normal)
        } else {
            passwordConfirmation.isSecureTextEntry = true
            showConfirmPasswordButton.setImage(UIImage.init(systemName: "eye"), for: .normal)
        }
...
// MARK: - Alamofire
extension CompleteCreateAccountViewController {
...
extension CompleteCreateAccountViewController: KeyboardAppearenceDelegate {
